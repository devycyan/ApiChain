...
#[derive(Debug)]
pub struct ApiChainProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ApiChainProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ApiChain processing");
    
    let mut processor = ApiChainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ApiChainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ApiChainProcessor::new(false);
